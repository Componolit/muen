...
is
   ...
   Kernel_BSS_Section_Addr          : constant := 16#0012_1000#;
   Kernel_BSS_Section_Size          : constant := 16#0000_2000#;
   Kernel_Stack_Addr                : constant := 16#0012_5000#;
   Kernel_Stack_Size                : constant := 16#0000_1000#;
   Kernel_Interrupt_Stack_Addr      : constant := 16#0012_7000#;
   Kernel_Interrupt_Stack_Size      : constant := 16#0000_1000#;
   Kernel_Global_Data_Section_Addr  : constant := 16#0012_9000#;
